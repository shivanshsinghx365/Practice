...
#shows & exits very fast

k=cv2.waitKey(1)#wait is for waitins the number in brackets is in mili seconds
...
elif k==ord('s'):   #ord takes a key as input and checks if it is s or not
